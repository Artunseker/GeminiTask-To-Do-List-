...
SECRET_KEY = "a4hrcymdkuk8tlpovexx4d3yyuwtgfwirk2gy22si1cd2c1gblcsqh5ooz0qyv58"
ALGORITHM= "HS256"
...
async def create_user(db: db_dependency, create_user:CreateUser):
    user = User(
        ...
        is_active=True,
        hashed_password=bcrypt.hash(create_user.password),
...
@router.post("/token",response_model=Token,status_code=status.HTTP_201_CREATED) #BURAYI TEKRAR ET NOLUR NOLMAZ
